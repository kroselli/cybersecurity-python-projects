...
The purpose of this repo is to demonstrate hands-on experience with core security concepts such as
network reconnaissance, log analysis, and password security.
